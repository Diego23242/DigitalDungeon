            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="game-card-descuento">
                        ...
                        <img src="Img/mando1.jpg" alt="Juego 1">
                        <div class="card-body">
                    ...
                    <div class="game-card-descuento">
                        <img src="Img/mando2.jpg" alt="Juego 1">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="game-card-descuento">
                        <img src="Img/mando3.jpg" alt="Juego 1">
                        <div class="card-body">
                    ...
                    <div class="game-card-descuento">
                        ...
                        <img src="Img/mando4.jpg" alt="Juego 1">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="game-card-descuento">
                        <img src="Img/mando5.jpg" alt="Juego 1">
                        <div class="card-body">
                    ...
                    <div class="game-card-descuento">
                        <img src="Img/mando6.jpg" alt="Juego 1">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="game-card-descuento">
                        <img src="Img/mando7.jpg" alt="Juego 2">
                        <div class="card-body">
                    ...
                    <div class="game-card-descuento">
                        ...
                        <img src="Img/mandos8.jpg" alt="Juego 1">
                        <div class="card-body">
